    ...
    return (
        <ToastPrimitives.Root
            ...
            className={cn(
                ...
                variant === "info" && "bg-blue-600 border-blue-600 text-white",
                !variant && "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700",
                // Animation
...
Toast.propTypes = {
    className: PropTypes.string,
    variant: PropTypes.oneOf(["default", "destructive", "success", "info"]),
};
